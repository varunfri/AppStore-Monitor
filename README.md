<p align="center">
  <img src="assets/app_icon.png" alt="App Store Connect Monitor Icon" width="120" />
</p>

<h1 align="center">App Store Connect Monitor</h1>

<p align="center">
  A clean-architecture, production-ready Flutter application for Android that allows developers to monitor their Apple App Store Connect account.<br/><br/>
  Authentication and token signing occur entirely on-device, utilizing local ES256 cryptography.<br/>
  <strong>No third-party backend is involved</strong> — your sensitive Apple Developer private keys never leave your device.
</p>
